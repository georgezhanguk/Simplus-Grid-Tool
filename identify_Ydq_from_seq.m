function [Y11, Y12, Y21, Y22, ...
          VdD, VqD, IdD, IqD, ...
          VdQ, VqQ, IdQ, IqQ] = identify_Ydq_from_seq(t,vd,vq,id,iq,f, f_list)
...
%                     Y = [Y11 Y12; Y21 Y22] at each frequency.
    ...
    for k = 1:Nf
        ...
        idxQ = idx_all(end-nt_cycle*9-nt_interval:end-nt_cycle-nt_interval);
    ...
    Y11(k) = Yk(1,1);  Y12(k) = Yk(1,2);
    Y21(k) = Yk(2,1);  Y22(k) = Yk(2,2);
    end
%%
figure
plot(abs(IdD))
